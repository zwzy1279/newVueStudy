        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,index) in skuSaleAttrValueList" :key="spuSaleAttr.id">
                <dt class="title">{{ spuSaleAttr.saleAttrName }}</dt>
                <dd changepirce="0" class="active">{{ spuSaleAttr.saleAttrValueName }}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
  ...
  export default {
    ...
    methods:{
      ...
      changeSkuNum(event){
        ...
        if(isNaN(value)||value<1){//不正常的情况下，用户输入不是数字的情况.或者输入的数字是小数
          this.skuNum=1;
        }else{//用户输入的是数字的正常情况
          //但是也不允许是小数，所以parseInt
